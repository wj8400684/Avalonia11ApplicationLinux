...
public static class FontsExtension
{
    public static class FontSettings
    {
        ...
        public static Uri Source { get; } = new Uri("avares://AvaloniaApplication1/Assets/Fonts", UriKind.Absolute);
    }
    ...
    public static AppBuilder UseFontFamily([DisallowNull] this AppBuilder builder)
    {
        ...
        {
            DefaultFamilyName = "avares://AvaloniaApplication1/Assets/Fonts/my.ttf#Microsoft YaHei",
            FontFallbacks = new[]
            {
                new  FontFallback
                {
                    FontFamily = new FontFamily("avares://AvaloniaApplication1/Assets/Fonts/my.ttf#Microsoft YaHei")
                }
            }
        });
